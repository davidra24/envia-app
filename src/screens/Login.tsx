                ...
                {isLoading ? (
                    ...
                    <>
                        ...
                        <View style={buttonContainer}>
                            <Button onPress={handleLogin} mode="contained" style={buttonLogin} color='#FFFFFF'>
                                Iniciar Sesión
                            </Button>
                            <Button disabled={!validatedMail} onPress={resetPassword} mode="contained" style={buttonLogin} color={'#FFFFFF'}>
